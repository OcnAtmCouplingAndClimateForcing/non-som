...
dir.output <- file.path(wd,"output","freeAR_5")
dir.figs <- file.path(wd,"plots", "freeAR_5")
...
write.csv(list.phi, file=file.path(dir.output,"list.phi.csv")) 
...
g.ratio2
ggsave(file=file.path(dir.figs, "Regional Ratio Param.pdf"), plot=g.ratio2,
